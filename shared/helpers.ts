export default {
  ...
  'has_projectile(for_age)': 'has_explosives or (for_age == child and (Slingshot or Boomerang)) or (for_age == adult and (Bow or Hookshot)) or (for_age == both and (Slingshot or Boomerang) and (Bow or Hookshot)) or (for_age == either and (Slingshot or Boomerang or Bow or Hookshot))',
  'can_use(item)': '(_is_magic_item(item) and item and Magic_Meter) or (_is_adult_item(item) and is_adult and item) or (_is_magic_arrow(item) and is_adult and item and Bow and Magic_Meter) or (_is_child_item(item) and is_child and item)',
  ...
  'can_build_rainbow_bridge': "( (bridge == 'open') or (bridge == 'vanilla' and Shadow_Medallion and Spirit_Medallion and Light_Arrows) or (bridge == 'stones' and has_stones(bridge_stones)) or (bridge == 'medallions' and has_medallions(bridge_medallions)) or (bridge == 'dungeons' and has_dungeon_rewards(bridge_rewards)) or (bridge == 'tokens' and (Gold_Skulltula_Token, bridge_tokens)))",
  'can_trigger_lacs': "( (lacs_condition == 'vanilla' and Shadow_Medallion and Spirit_Medallion) or (lacs_condition == 'stones' and has_stones(lacs_stones)) or (lacs_condition == 'medallions' and has_medallions(lacs_medallions)) or (lacs_condition == 'dungeons' and has_dungeon_rewards(lacs_rewards)) or (lacs_condition == 'tokens' and (Gold_Skulltula_Token, lacs_tokens)))",
};
