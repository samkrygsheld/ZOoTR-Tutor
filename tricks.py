...
Trick("Wolfos Grotto Chest", 'Hidden Grottos without Stone of Agony', [{'agony':0}], 'easy', 'both', True, 'https://www.zeldadungeon.net/wiki/Ocarina_of_Time_Hidden_Grottos')
##Trick("Remote Southern Grotto Chest", 'Hidden Grottos without Stone of Agony', [{'agony':0}], 'easy', 'both', True, 'https://www.zeldadungeon.net/wiki/Ocarina_of_Time_Hidden_Grottos')
Trick("HF Grotto Deku Scrub Piece of Heart", 'Hidden Grottos without Stone of Agony', [{'agony':0}], 'easy', 'both', True, 'https://www.zeldadungeon.net/wiki/Ocarina_of_Time_Hidden_Grottos')
##Trick("Field West Castle Town Grotto Chest", 'Hidden Grottos without Stone of Agony', [{'agony':0}], 'easy', 'both', True, 'https://www.zeldadungeon.net/wiki/Ocarina_of_Time_Hidden_Grottos')
##Trick("Tektite Grotto Freestanding PoH", 'Hidden Grottos without Stone of Agony', [{'agony':0}], 'easy', 'both', True, 'https://www.zeldadungeon.net/wiki/Ocarina_of_Time_Hidden_Grottos')
Trick("Redead Grotto Chest", 'Hidden Grottos without Stone of Agony', [{'agony':0}], 'easy', 'both', True, 'https://www.zeldadungeon.net/wiki/Ocarina_of_Time_Hidden_Grottos')
...
Trick("Kakariko", 'Graveyard Side to Goron Side with Hookshot', {'shot':1}, 'easy', 'adult', True, 'https://youtu.be/lCO9gA3_AwU?t=4343')
Trick("Graveyard", 'Faster Grave Pull with Poe Damage Boost', True, 'medium', 'adult', True, 'https://youtu.be/lCO9gA3_AwU?t=4216')
Trick("Zora's River", 'Jump to Bean Salesman from Domain Side', True, 'easy', 'both', True, 'https://www.youtube.com/watch?v=2Eu5AnwbJqE&t=3185')
